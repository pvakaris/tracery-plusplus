...
villainPersonality can have values: 'wicked', 'malevolent', 'sinister', 'villainous', 'diabolical', 'maleficent', 'malignant', 'nefarious', 'demonic', 'fiendish', 'cruel', 'malicious', 'satanic', 'devilish', 'corrupt', 'perverse'
possiblePrincessName can be: "Cinderella", "Aurora", "Belle", "Rapunzel", "Jasmine", "Merida", "Elsa", "Moana", "Anna", "Tiana"
possiblePrinceName can be: "Prince Charming" or "Phillip" or "Beast" or "Flynn Rider" or "Aladdin" or "Naveen" or "Kristoff" or "Hercules" or "John Smith" or "Li Shang"
possibleVillainName can be: "Maleficent", "Jafar", "Ursula", "Scar", "Cruella de Vil", "Gaston", "Hades", "Captain Hook", "Evil Queen", "Yzma", "Shere Khan", "Doctor Facilier", "Mother Gothel", "Queen of Hearts", "Gotham's Joker", "Thanos", "Darth Vader", "Kylo Ren", "Lord Voldemort", "Sauron"
trait can be:"bravery", "cleverness", "kindness", "charisma", "beauty", "wit", "independence", "generosity", "resourcefulness", "compassion"
villainOccupation can be: "evil queen", "dragon", "witch", "sorcerer", "giant", "ogre", "demon", "monster", "villain", "curse"
...
There is a prince
He has attributes: name = possiblePrinceName, location

There is a princess
She has attributes: name = possiblePrincessName, location, food = favFood

There is an villain
It has attributes: name = possibleVillainName, occupation = villainOccupation
