...
public class TraceryPlusPlusParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TraceryPlusPlusGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getObjectAttributeAccess().getAlternatives_2(), "rule__ObjectAttribute__Alternatives_2");
			...
			builder.put(grammarAccess.getListVariableAccess().getGroup(), "rule__ListVariable__Group__0");
			...
			builder.put(grammarAccess.getWordAccess().getNameAssignment(), "rule__Word__NameAssignment");
			builder.put(grammarAccess.getListVariableAccess().getVariableAssignment_0(), "rule__ListVariable__VariableAssignment_0");
			builder.put(grammarAccess.getListVariableAccess().getModifiersAssignment_1(), "rule__ListVariable__ModifiersAssignment_1");
			...
			builder.put(grammarAccess.getObjectAttributeAccess().getAttributeAssignment_2_0(), "rule__ObjectAttribute__AttributeAssignment_2_0");
			builder.put(grammarAccess.getObjectAttributeAccess().getPronounAssignment_2_1(), "rule__ObjectAttribute__PronounAssignment_2_1");
