...
public class TraceryPlusPlusSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        TraceryPlusPlusProgram traceryPlusPlusProgram = (TraceryPlusPlusProgram)theEObject;
        T result = caseTraceryPlusPlusProgram(traceryPlusPlusProgram);
      ...
      {
        ModifierList modifierList = (ModifierList)theEObject;
        T result = caseModifierList(modifierList);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseTraceryPlusPlusProgram(TraceryPlusPlusProgram object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Modifier List</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Modifier List</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseModifierList(ModifierList object)
  {
    return null;
  }
